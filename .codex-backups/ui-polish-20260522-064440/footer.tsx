      ...
      <div className="page-shell">
        ...
        <div className="ftr-grid">
          ...
          <div className="ftr-brand">
            <div className="ftr-logo">
              <div className="ftr-logo-mark" aria-hidden>
                <svg width="16" height="16" viewBox="0 0 18 18" fill="none" aria-hidden>
                  <path d="M2.5 9.5L7 14L15.5 4" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div>
                <span className="ftr-logo-name">UDF</span>
                <span className="ftr-logo-sub">PROMISE TRACKER</span>
              </div>
            </div>
            <p className="ftr-tagline">
              Kerala&apos;s independent tracker for every promise made by the UDF government — built for accountability, not politics.
            </p>
            ...
            <div className="ftr-snapshot">
              ...
              <div className="ftr-snap-item">
                <span className="ftr-snap-num">{fulfillRate}%</span>
                <span className="ftr-snap-label">Fulfilled</span>
              </div>
              <div className="ftr-snap-divider" />
              <div className="ftr-snap-item">
                <span className="ftr-snap-num">{meta.fulfilled}</span>
                <span className="ftr-snap-label">Delivered</span>
              </div>
            </div>
          </div>
        ...
        <div className="ftr-bottom">
          <p className="ftr-copy">
            © {new Date().getFullYear()} UDF Promise Tracker · Data sourced from UDF Manifesto 2026
          </p>
