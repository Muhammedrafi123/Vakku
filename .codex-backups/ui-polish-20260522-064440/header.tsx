  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/[0.06] bg-[#0a0a0a]/95 backdrop-blur-md">
      <div className="page-shell flex min-h-16 items-center justify-between gap-5 py-2">
        ...
        {/* Logo */}
        <Link href="/" className="flex items-center gap-3 shrink-0" aria-label="UDF Promise Tracker home">
          <div className="flex h-9 w-9 items-center justify-center bg-[#E8821A] rounded-[3px]">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" aria-hidden>
              <path d="M2.5 9.5L7 14L15.5 4" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
          <div className="leading-none">
            <span className="block text-[13px] font-bold text-white tracking-wide">UDF</span>
