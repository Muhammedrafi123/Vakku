...
const checks = [
  ...
  { name: "manifesto", url: "http://localhost:3000/manifesto/2026", width: 1280, height: 900, text: "UDF Manifesto 2026" },
  { name: "category", url: "http://localhost:3000/category/healthcare", width: 1280, height: 900, text: "Healthcare promises" },
  { name: "status", url: "http://localhost:3000/status/not-started", width: 1280, height: 900, text: "Not started UDF promises" },
];
